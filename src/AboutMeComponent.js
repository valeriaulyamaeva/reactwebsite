...
import { Box, Grid, Typography, Button, List, ListItem, ListItemText, IconButton, Link } from '@mui/material';
...
<Box sx={{ marginTop: '6rem', textAlign: 'left', fontSize: '0.5rem', color: '#fff' }}>
  <Typography>Copyright ©2025 Антон Павлов. Все права защищены.</Typography>
      ...
      <Box sx={{ backgroundColor: '#fff', marginBottom: '1rem', marginLeft: '3rem' }}>
